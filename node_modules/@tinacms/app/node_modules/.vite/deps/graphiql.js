...
} from "./chunk-JB2Y2OP2.js";
import {
  require_jsx_runtime
} from "./chunk-PR4J3WY5.js";
import {
  useVirtualizer
} from "./chunk-7DOWBVO7.js";
import {
  require_react_dom
} from "./chunk-R3MWAUXA.js";
import {
  HistoryStore,
  StorageAPI,
...
async function Se5(e4, t18) {
  const n7 = await import("./codemirror.es-J3HDNRWI.js").then((r10) => r10.c).then(
    (r10) => (
  ...
  return await Promise.all(
    (t18 == null ? void 0 : t18.useCommonAddons) === false ? e4 : [
      import("./show-hint.es-L2VNHJ5S.js").then((r10) => r10.s),
      import("./matchbrackets.es-7ZPTT6JD.js").then((r10) => r10.m),
      import("./closebrackets.es-6FEDYWLP.js").then((r10) => r10.c),
      import("./brace-fold.es-3B6XKADV.js").then((r10) => r10.b),
      import("./foldgutter.es-NUNJZTIY.js").then((r10) => r10.f),
      import("./lint.es-FTGBDOC2.js").then((r10) => r10.l),
      import("./searchcursor.es-HRP3W74H.js").then((r10) => r10.s),
      import("./jump-to-line.es-7JNCPAM5.js").then((r10) => r10.j),
      import("./dialog.es-NPOUOWRB.js").then((r10) => r10.d),
      // @ts-expect-error
      import("./sublime.es-NZGORK67.js").then((r10) => r10.s),
      ...e4
    ]
  ), n7;
}
...
function Ce3({
  ...
  return (0, import_react93.useEffect)(() => {
    ...
    return Se5([
      // @ts-expect-error
      import("./javascript.es-HDYE6TOW.js").then((C7) => C7.j)
    ]).then((C7) => {
      if (!g5)
        return;
...
function se4({
  ...
  (0, import_react93.useEffect)(() => {
    ...
    let A3 = true;
    return Se5([
      import("./comment.es-PBXRFEHW.js").then((k3) => k3.c),
      import("./search.es-KAXSTF3A.js").then((k3) => k3.s),
      import("./hint.es-BJUKO3TB.js"),
      import("./lint.es2-TGWZZWDF.js"),
      import("./info.es-JWDZDNLF.js"),
      import("./jump.es-HGYNVYSB.js"),
      import("./mode.es-PH2SIOAG.js")
    ]).then((k3) => {
      if (!A3)
        return;
      D7.current = k3;
...
function me4({
  ...
  return (0, import_react93.useEffect)(() => {
    let C7 = true;
    return Se5([
      import("./hint.es2-STSMOPL4.js"),
      import("./lint.es3-KL75XJWF.js"),
      import("./mode.es2-RFLJ2T7I.js")
    ]).then((d16) => {
      if (!C7)
        return;
      g5.current = d16;
...
function it4({
  ...
  return (0, import_react93.useEffect)(() => {
    ...
    return Se5(
      [
        import("./foldgutter.es-NUNJZTIY.js").then((u13) => u13.f),
        import("./brace-fold.es-3B6XKADV.js").then((u13) => u13.b),
        import("./dialog.es-NPOUOWRB.js").then((u13) => u13.d),
        import("./search.es-KAXSTF3A.js").then((u13) => u13.s),
        import("./searchcursor.es-HRP3W74H.js").then((u13) => u13.s),
        import("./jump-to-line.es-7JNCPAM5.js").then((u13) => u13.j),
        // @ts-expect-error
        import("./sublime.es-NZGORK67.js").then((u13) => u13.s),
        import("./mode.es3-EPZCOW2J.js"),
        import("./info-addon.es-TH5B7NTR.js")
      ],
