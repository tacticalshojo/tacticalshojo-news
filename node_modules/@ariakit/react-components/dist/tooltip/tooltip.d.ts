 ...
 * ```
 */
declare const useTooltip: import("@ariakit/react-utils").Hook<"div", TooltipOptions<"div">>;
/**
 ...
 * ```
 */
declare const Tooltip: (props: TooltipProps<"div">) => import("react").JSX.Element | null;
interface TooltipOptions<T extends ElementType = TagName> extends HovercardOptions<T> {
  /**
...
type TooltipProps<T extends ElementType = TagName> = Props<T, TooltipOptions<T>>;
//#endregion
export { Tooltip, TooltipOptions, TooltipProps, useTooltip };
