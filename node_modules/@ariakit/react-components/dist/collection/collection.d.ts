import { t as CollectionStore } from "../collection-store-CbwzYsWf.js";
import { Options, Props } from "@ariakit/react-utils";
import { ElementType } from "react";

//#region src/collection/collection.d.ts
 ...
 * ```
 */
declare const useCollection: import("@ariakit/react-utils").Hook<"div", CollectionOptions<"div">>;
/**
...
type CollectionProps<T extends ElementType = TagName> = Props<T, CollectionOptions<T>>;
//#endregion
export { Collection, CollectionOptions, CollectionProps, useCollection };
