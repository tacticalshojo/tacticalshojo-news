import { c as getCollectionRendererItem, l as getCollectionRendererItemId } from "../collection-renderer-CicyN-E1.js";
...
//#region src/select/select-renderer.d.ts
...
type SelectRendererItemProps<T extends Item, P extends BaseItemProps = BaseItemProps> = ItemProps<T, P>;
interface SelectRendererOptions<T extends Item = any> extends Omit<CompositeRendererOptions<T>, "store"> {
  /**
...
interface SelectRendererProps<T extends Item = any> extends Props<TagName, SelectRendererOptions<T>> {}
//#endregion
export { SelectRenderer, SelectRendererBaseItemProps, SelectRendererItem, SelectRendererItemObject, SelectRendererItemProps, SelectRendererOptions, SelectRendererProps, getCollectionRendererItem as getSelectRendererItem, getCollectionRendererItemId as getSelectRendererItemId };
