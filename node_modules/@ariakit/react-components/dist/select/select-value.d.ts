...
import { PickRequired, ToPrimitive } from "@ariakit/utils";
 ...
 * ```
 */
declare function SelectValue<T extends Value = Value>(props: PickRequired<SelectValueProps<T>, "fallback">): T;
declare function SelectValue(props?: SelectValueProps): Value;
interface SelectValueProps<T extends Value = Value> {
  /**
