...
const usePopoverArrow = createHook(function usePopoverArrow({ store, size = defaultSize, borderWidth: borderWidthProp, ...props }) {
	...
	const dir = useStoreState(store, (state) => getBasePlacement(state.currentPlacement));
	const maskId = useId();
