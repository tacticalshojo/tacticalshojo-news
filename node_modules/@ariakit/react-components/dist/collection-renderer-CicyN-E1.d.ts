...
declare function useCollectionRenderer<T extends Item = any>({
  store,
  items: itemsProp,
  initialItems,
  gap,
...
type CollectionRendererItem = Item;
type CollectionRendererBaseItemProps = BaseItemProps;
type CollectionRendererItemProps<T extends Item, P extends BaseItemProps = BaseItemProps> = ItemProps<T, P>;
interface CollectionRendererOptions<T extends Item = any> extends Options {
  /**
...
//# sourceMappingURL=collection-renderer-CicyN-E1.d.ts.map