import { r as CollectionStoreItem } from "../collection-store-CbwzYsWf.js";
import { a as CollectionRendererItemProps, c as getCollectionRendererItem, i as CollectionRendererItemObject, l as getCollectionRendererItemId, n as CollectionRendererBaseItemProps, o as CollectionRendererOptions, r as CollectionRendererItem } from "../collection-renderer-CicyN-E1.js";
import { r as CompositeStoreItem, t as CompositeStore } from "../composite-store-DyJc-XRA.js";
import { Props } from "@ariakit/react-utils";
import { ReactNode } from "react";

//#region src/composite/composite-renderer.d.ts
...
declare function useCompositeRenderer<T extends Item = any>({
  store,
  ...
  children: ReactNode[];
  wrapElement?: import("@ariakit/react-utils").WrapElement;
  render?: import("@ariakit/react-utils").RenderProp | import("react").ReactElement;
...
type CompositeRendererItemObject = ItemObject;
type CompositeRendererItem = Item;
type CompositeRendererBaseItemProps = BaseItemProps;
type CompositeRendererItemProps<T extends Item, P extends BaseItemProps = BaseItemProps> = ItemProps<T, P>;
declare const CompositeRenderer: <T extends Item = any>(props: CompositeRendererProps<T>) => import("react").ReactElement<unknown, string | import("react").JSXElementConstructor<any>>;
interface CompositeRendererOptions<T extends Item = any> extends Omit<CollectionRendererOptions<T>, "store" | "children"> {
  /**
...
interface CompositeRendererProps<T extends Item = any> extends Props<TagName, CompositeRendererOptions<T>> {}
//#endregion
export { CompositeRenderer, CompositeRendererBaseItemProps, CompositeRendererItem, CompositeRendererItemObject, CompositeRendererItemProps, CompositeRendererOptions, CompositeRendererProps, getCollectionRendererItem as getCompositeRendererItem, getCollectionRendererItemId as getCompositeRendererItemId, useCompositeRenderer };
//# sourceMappingURL=composite-renderer.d.ts.map