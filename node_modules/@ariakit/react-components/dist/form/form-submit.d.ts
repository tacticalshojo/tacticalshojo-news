...
//#region src/form/form-submit.d.ts
 ...
 * ```
 */
declare const useFormSubmit: import("@ariakit/react-utils").Hook<"button", FormSubmitOptions<"button">>;
/**
...
type FormSubmitProps<T extends ElementType = TagName> = Props<T, FormSubmitOptions<T>>;
//#endregion
export { FormSubmit, FormSubmitOptions, FormSubmitProps, useFormSubmit };
