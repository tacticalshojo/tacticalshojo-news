...
//#region src/form/form-label.d.ts
 ...
 * ```
 */
declare const useFormLabel: import("@ariakit/react-utils").Hook<"label", FormLabelOptions<"label">>;
/**
...
type FormLabelProps<T extends ElementType = TagName> = Props<T, FormLabelOptions<T>>;
//#endregion
export { FormLabel, FormLabelOptions, FormLabelProps, useFormLabel };
