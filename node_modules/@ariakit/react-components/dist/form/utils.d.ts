 ...
 */
declare function isArrayFieldName(fieldName: string, name: string): boolean;
/**
 ...
 */
declare function getArrayFieldIndex(fieldName: string, name: string): number;
//#endregion
export { getArrayFieldIndex, isArrayFieldName };
