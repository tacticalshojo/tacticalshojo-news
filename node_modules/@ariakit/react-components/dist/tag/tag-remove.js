...
import { createElement, createHook, forwardRef, useBooleanEvent, useEvent, useId } from "@ariakit/react-utils";
import { invariant } from "@ariakit/utils";
import { useContext, useEffect } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/tag/tag-remove.tsx
...
const useTagRemove = createHook(function useTagRemove({ store, value: valueProp, removeOnClick = true, ...props }) {
	...
	const children = withinTag ? /* @__PURE__ */ jsxs("svg", {
		display: "block",
		viewBox: "0 0 24 24",
		fill: "none",
		stroke: "currentColor",
...
* ```
*/
const TagRemove = forwardRef(function TagRemove(props) {
	return createElement(TagName, useTagRemove(props));
});
//#endregion
export { TagRemove, useTagRemove };

//# sourceMappingURL=tag-remove.js.map