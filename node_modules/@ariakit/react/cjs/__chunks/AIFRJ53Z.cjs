...
var _4Q5TABN7cjs = require('./4Q5TABN7.cjs');
...
function getFlipMiddleware(props) {
  ...
  _LZ6L3ECGcjs.invariant.call(void 0, !fallbackPlacements || fallbackPlacements.every(isValidPlacement), process.env.NODE_ENV !== "production" && "`flip` expects a spaced-delimited list of placements");
  return flip2({
...
var usePopover = _LZ6L3ECGcjs.createHook.call(void 0, function usePopover2({ store, modal = false, portal = modal, preserveTabOrder = true, autoFocusOnShow = true, wrapperProps, fixed = false, flip: flip3 = true, shift: shift3 = 0, slide = true, overlap = false, sameWidth = false, fitViewport = false, gutter, arrowPadding = 4, overflowPadding = 8, getAnchorRect, updatePosition, ...props }) {
  const context = _4Q5TABN7cjs.usePopoverProviderContext.call(void 0, );
  store = store || context;
  _LZ6L3ECGcjs.invariant.call(void 0, store, process.env.NODE_ENV !== "production" && "Popover must receive a `store` prop or be wrapped in a PopoverProvider component.");
  const arrowElement = _5FQZLBJ7cjs.useStoreState.call(void 0, store, "arrowElement");
  const anchorElement = _5FQZLBJ7cjs.useStoreState.call(void 0, store, "anchorElement");
  const disclosureElement = _5FQZLBJ7cjs.useStoreState.call(void 0, store, "disclosureElement");
  const popoverElement = _5FQZLBJ7cjs.useStoreState.call(void 0, store, "popoverElement");
  const contentElement = _5FQZLBJ7cjs.useStoreState.call(void 0, store, "contentElement");
  const placement = _5FQZLBJ7cjs.useStoreState.call(void 0, store, "placement");
  const mounted = _5FQZLBJ7cjs.useStoreState.call(void 0, store, "mounted");
  const rendered = _5FQZLBJ7cjs.useStoreState.call(void 0, store, "rendered");
  ...
  const { portalRef, domReady } = _LZ6L3ECGcjs.usePortalRef.call(void 0, portal, props.portalRef);
  const getAnchorRectProp = _LZ6L3ECGcjs.useEvent.call(void 0, getAnchorRect);
  const updatePositionProp = _LZ6L3ECGcjs.useEvent.call(void 0, updatePosition);
  ...
  props = _LZ6L3ECGcjs.useWrapElement.call(void 0, props, (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", {
    ...wrapperProps,
    style: {
      position,
      top: 0,
  ...
  props = _LZ6L3ECGcjs.useWrapElement.call(void 0, props, (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _4Q5TABN7cjs.PopoverScopedContextProvider, {
    value: store,
    children: element
  }), [store]);
  props = {
  ...
  props = _KJ5H7OHHcjs.useDialog.call(void 0, {
    store,
    modal,
    portal,
    preserveTabOrder,
...
var Popover = _KJ5H7OHHcjs.createDialogComponent.call(void 0, _LZ6L3ECGcjs.forwardRef.call(void 0, function Popover2(props) {
  return _LZ6L3ECGcjs.createElement.call(void 0, TagName, usePopover(props));
}), _4Q5TABN7cjs.usePopoverProviderContext);

// ../ariakit-components/dist/popover/popover-store.js
function createPopoverStore({ popover: otherPopover, ...props } = {}) {
  const store = _5FQZLBJ7cjs.mergeStore.call(void 0, props.store, _5FQZLBJ7cjs.omit.call(void 0, otherPopover, [
    "arrowElement",
    "anchorElement",
    "contentElement",
    "popoverElement",
  ...
  _5FQZLBJ7cjs.throwOnConflictingProps.call(void 0, props, store);
  const syncState = store == null ? void 0 : store.getState();
  const dialog = _KJ5H7OHHcjs.createDialogStore.call(void 0, {
    ...props,
    store
  });
  const placement = _LZ6L3ECGcjs.defaultValue.call(void 0, props.placement, syncState == null ? void 0 : syncState.placement, "bottom");
  const popover = _5FQZLBJ7cjs.createStore.call(void 0, {
    ...dialog.getState(),
    placement,
    currentPlacement: placement,
    anchorElement: _LZ6L3ECGcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.anchorElement, null),
    popoverElement: _LZ6L3ECGcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.popoverElement, null),
    arrowElement: _LZ6L3ECGcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.arrowElement, null),
...
function usePopoverStoreProps(store, update, props) {
  _LZ6L3ECGcjs.useUpdateEffect.call(void 0, update, [props.popover]);
  _5FQZLBJ7cjs.useStoreProps.call(void 0, store, props, "placement");
  return _KJ5H7OHHcjs.useDialogStoreProps.call(void 0, store, update, props);
}
function usePopoverStore(props = {}) {
  const [store, update] = _5FQZLBJ7cjs.useStore.call(void 0, createPopoverStore, props);
