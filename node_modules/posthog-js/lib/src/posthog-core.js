...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype._handle_unload = function () {
        ...
        (_c = this.logs) === null || _c === void 0 ? void 0 : _c.flushLogs('sendBeacon');
    ...
    PostHog.prototype.reset = function (reset_device_id) {
        ...
        (_l = this.persistence) === null || _l === void 0 ? void 0 : _l.set_property(constants_1.USER_STATE, constants_1.USER_STATE_ANONYMOUS);
        (_m = this.sessionManager) === null || _m === void 0 ? void 0 : _m.resetSessionId();
        this._cachedPersonProperties = null;
    ...
    PostHog.prototype.shutdown = function (_shutdownTimeoutMs) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                ...
                (_d = this.featureFlags) === null || _d === void 0 ? void 0 : _d.destroy();
                return [2 /*return*/];
            });
        });
    };
